...
public class QuestionTabStrip extends HorizontalScrollView {
	...
	public boolean for_doquiz = false;
	...
	private int indicatorColor = 0xFF999999;
	...
	public QuestionTabStrip(Context context) {
		this(context, null);
	}

	public QuestionTabStrip(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

    @SuppressWarnings("ResourceType")
	public QuestionTabStrip(Context context, AttributeSet attrs, int defStyle) {
	...
	public void changecolor(int position, int color) {		
		TextView textview = (TextView) tabsContainer.findViewById(100 + position);
	...
	private void addTextTab(final int position, String title) {
		...
		// if (pager.getAdapter() instanceof QuestionSliderAdapter) {
		// tab.setTextColor(((QuestionSliderAdapter) pager.getAdapter()).getPageColor(position));
		// }
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				tab.setTextSize(tab.getTextSize() / MyGlobal.scaledDensity * MyGlobal.ScreenScale);
...
//		else
			canvas.drawRect(0, tabsContainer.getHeight() - underlineHeight, tabsContainer.getWidth(), tabsContainer.getHeight(), rectPaint);

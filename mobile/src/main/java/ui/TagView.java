...
public class TagView extends LinearLayout {
    ...
    public void drawTags() {
        ...
        for (Tag item : mTags) {
            ...
            tagView.setId(1234 * position);
            tagView.setText(Html.fromHtml(tag.text));
            ...
            float tagWidth = tagView.getPaint().measureText(tag.tokens.text.content) + textPaddingLeft + textPaddingRight;
            ...
            if (tag.tokens.text.content.equals(".")) {
                tagView.setVisibility(GONE);
            }

            if (mWidth <= total + tagWidth + Utils.dipToPx(this.getContext(), Constants.LAYOUT_WIDTH_OFFSET) || tag.tokens.text.content.equals(".")) {
